...
from src.theme import apply_global_theme
...
try:
    # Import local modules from the installed src package
    from src.splash_screen import ZenFlowSplashScreen as SplashScreen
